...
namespace levantamiento.DataAccess.Database
{
    public class DataProve
    {
        ...
        public void GetSolicitudReparacionData()
        {
            ...
            {
                Id = Guid.Parse("0c5c3262-d5ef-46c7-bc0e-97530821c0cc"),
        ...
        public void getPartesData()
        {
            parteInit.Add( new Parte{
                Id = Guid.Parse( "0c5c3262-d5ef-46c7-1000-97530821c04b"),
                nombre = "puerta izquierda delantera",
            });
            parteInit.Add( new Parte{
                Id = Guid.Parse( "0c5c3262-d5ef-46c7-2000-97530821c04b"),
                nombre = "puerta derecha delantera", 
            });
            parteInit.Add( new Parte{
                Id = Guid.Parse( "0c5c3262-d5ef-46c7-3000-97530821c04b"),
                nombre = "rueda", 
            });
            parteInit.Add( new Parte{
                Id = Guid.Parse( "0c5c3262-d5ef-46c7-4000-97530821c04b"),
                nombre = "capó de motor", 
            });
            parteInit.Add( new Parte{
                Id = Guid.Parse( "0c5c3262-d5ef-46c7-5000-97530821c04b"),
                nombre = "capó de maleta", 
            });
            parteInit.Add( new Parte{
                Id = Guid.Parse( "0c5c3262-d5ef-46c7-7000-97530821c04b"),
                nombre = "rin", 
            });
        }
        public void getRequerimientosData()
        {
            requerimientoInit.Add( new Requerimiento{
                Id = Guid.Parse("0c5c3262-d5ef-46c7-bc0e-97530821c0c1"),
            ...
            requerimientoInit.Add( new Requerimiento{
                Id = Guid.Parse("0c5c3262-d5ef-2000-bc0e-97530821c04b"),
                solicitudReparacionId = Guid.Parse("0c5c3262-d5ef-46c7-bc0e-97530821c0cc"),
