...
namespace administracion.Migrations
{
    ...
    [Migration("20220624182737_correciones")]
            ...
            modelBuilder.Entity("administracion.Persistence.Entities.Incidente", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            incidenteId = new Guid("9a66ccc9-871a-432c-a3b6-972383e404da"),
                            estadoIncidente = 0,
            ...
            modelBuilder.Entity("administracion.Persistence.Entities.Poliza", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            polizaId = new Guid("0c5c3262-d5ef-46c7-bc0e-97530823c05b"),
                            fechaRegistro = new DateTime(2022, 6, 24, 14, 27, 37, 138, DateTimeKind.Local).AddTicks(5456),
                            fechaVencimiento = new DateTime(2022, 6, 24, 14, 27, 37, 138, DateTimeKind.Local).AddTicks(5456),
                            tipoPoliza = 0,
            ...
            modelBuilder.Entity("administracion.Persistence.Entities.Vehiculo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            aseguradoId = new Guid("0c5c3262-d5ef-46c7-bc0e-97530821c03b"),
                            color = 1,
                            fechaCompra = new DateTime(2022, 6, 24, 14, 27, 37, 138, DateTimeKind.Local).AddTicks(5441),
                            marca = 0,
                            placa = "AB320AM"
                        },
                        new
                        {
                            ...
                            aseguradoId = new Guid("0c5c3262-d5ef-46c7-bc0e-97530821c03f"),
                            color = 6,
                            fechaCompra = new DateTime(2022, 6, 24, 14, 27, 37, 138, DateTimeKind.Local).AddTicks(5453),
                            marca = 0,
                            placa = "AB322AM"
                        });
                });
