...
namespace administracion.Persistence.Database
{
    public class DataProve
    {
        ...
        public void getAseguradoData()
        {
            ...
            this.aseguradoInit.Add(new Asegurado(){
                aseguradoId=Guid.Parse("0c5c3262-d5ef-46c7-0001-000000000004"),
                nombre = "Maria Jose",
                apellido = "Salaguchi"
            }); 
        }
        ...
        public void GetMarcasTallerData()
        {
            ...
            marcasTallerInit.Add(new MarcaTaller{
                marcaId = Guid.Parse("00000001-d5ef-46c7-0005-000000000001"),
                tallerId =  Guid.Parse("0c5c3262-d5ef-46c7-0005-000000000001"),   
                manejaTodas = false,
                marca = Marca.General_Motors,
            });
            marcasTallerInit.Add(new MarcaTaller{
                marcaId = Guid.Parse("00000002-d5ef-46c7-0005-000000000001"),
                tallerId =  Guid.Parse("0c5c3262-d5ef-46c7-0005-000000000001"),   
                manejaTodas = false,
                marca = Marca.BMW,
            });
            marcasTallerInit.Add(new MarcaTaller{
                marcaId = Guid.Parse("00000003-d5ef-46c7-0005-000000000001"),
                tallerId =  Guid.Parse("0c5c3262-d5ef-46c7-0005-000000000001"),   
                manejaTodas = false,
                marca = Marca.Hyundai,
            });
            marcasTallerInit.Add(new MarcaTaller{
                marcaId = Guid.Parse("00000001-d5ef-46c7-0005-000000000002"),
                tallerId =  Guid.Parse("0c5c3262-d5ef-46c7-0005-000000000002"),   
                manejaTodas = true,
                marca = null,
            });
        ...
        public void GetMarcasProveedorData()
        {
            ...
            marcasProveedorInit.Add(new MarcaProveedor{
                marcaId = Guid.Parse("00000001-d5ef-46c7-0006-000000000001"),
                proveedorId =  Guid.Parse("0c5c3262-d5ef-46c7-0006-000000000001"),   
                manejaTodas = false,
                marca = Marca.General_Motors,
            });
            marcasProveedorInit.Add(new MarcaProveedor{
                marcaId = Guid.Parse("00000002-d5ef-46c7-0006-000000000001"),
                proveedorId =  Guid.Parse("0c5c3262-d5ef-46c7-0006-000000000001"),   
                manejaTodas = false,
                marca = Marca.Ford,
            });
            marcasProveedorInit.Add(new MarcaProveedor{
                marcaId = Guid.Parse("00000003-d5ef-46c7-0006-000000000001"),
                proveedorId =  Guid.Parse("0c5c3262-d5ef-46c7-0006-000000000001"),   
                manejaTodas = false,
                marca = Marca.Hyundai,
            });
            marcasProveedorInit.Add(new MarcaProveedor{
                marcaId = Guid.Parse("00000004-d5ef-46c7-0006-000000000001"),
                proveedorId =  Guid.Parse("0c5c3262-d5ef-46c7-0006-000000000001"),   
                manejaTodas = false,
                marca = Marca.Toyota,
            });
            marcasProveedorInit.Add(new MarcaProveedor{
                marcaId = Guid.Parse("00000001-d5ef-46c7-0006-000000000002"),
                proveedorId =  Guid.Parse("0c5c3262-d5ef-46c7-0006-000000000002"),   
                manejaTodas = true,
                marca = null,
            });
