    ...
    public static class DataSeedIncidenteProcess
    {
        public static void SetupDbContextDataIncidenteProcess(this Mock<IAdminDBContext> _mockContext)
        {
            var asegurados = new List<Asegurado>
            {
                ...
                {
                    Id = new Guid("00000001-12aa-46bf-82a2-05ff65bb2c86"),
                    nombre = "Rogelio",
                    apellido = "Zambrano",
                ...
                {
                    Id = new Guid("00000002-12aa-46bf-82a2-05ff65bb2c87"),
                    nombre = "Mario",
                    apellido = "Perez",
                    vehiculos = new List<Vehiculo>
                    {
                        ...
                        {
                            Id = new Guid("00f401c9-12aa-46bf-82a3-05ff65bb2c00"),
                            anioModelo = 2007,
                ...
                {
                    Id = new Guid("00000003-12aa-46bf-82a2-05ff65bb2c88"),
                    nombre = "Juan",
                    apellido = "Willson",
                    vehiculos = new List<Vehiculo>
                    {
                        ...
                        {
                            Id = new Guid("00f401c9-12aa-46bf-82a3-05bb34bb2c01"),
                            anioModelo = 2013,
                        ...
                        {
                            Id = new Guid("00f401c9-12aa-46bf-82a3-05bb34bb2c02"),
                            anioModelo = 2019,
                            fechaCompra = DateTime.Parse("03/08/2020"),
                            color = Color.Dorado,
                            placa = "CD231CM",
                            marca = MarcaName.Ford,
                            aseguradoId = new Guid("00000003-12aa-46bf-82a2-05ff65bb2c88"),
                            asegurado = new Asegurado(),
                            polizas = new List<Poliza>(),
                        }
            ...
            var vehiculos = asegurados.SelectMany(q => q.vehiculos!).Concat(new List<Vehiculo>
            {
                ...
                {
                    Id = new Guid("00f401c9-12aa-46bf-82a3-05bb34bb2c03"),
                    anioModelo = 2019,
                    fechaCompra = DateTime.Parse("15/05/2021"),
                    color = Color.Negro,
                    placa = "AB234CM",
                    marca = MarcaName.Audi,
                    aseguradoId = null,
                    asegurado = new Asegurado(),
                    polizas = new List<Poliza>(),
                },
            ...
            var polizas = new List<Poliza>
            {
                ...
                {
                    Id = Guid.Parse("000401c9-12aa-46bf-82a2-05ff65bb2000"),
                    ...
                    vehiculoId = vehiculos.ToList()[0].Id,
                    vehiculo = vehiculos.ToList()[0]
                },
                new Poliza //Poliza 1 (vigente, CoberturaCompleta)
                {
                    Id = Guid.Parse("000401c9-12aa-46bf-82a2-05ff65bb2001"),
                ...
                {
                    Id = Guid.Parse("000401c9-12aa-46bf-82a2-05ff65bb2002"),
                    ...
                    vehiculoId = vehiculos.ToList()[1].Id, 
            ...
            var incidentes = new List<Incidente>
            {
                new Incidente
                {
                    Id = Guid.Parse("000001c9-12aa-46bf-82a2-05ff65bb0000"),
